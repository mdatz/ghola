...
import { Card, Center, Container, Divider, Text, Button, Modal, PasswordInput, Code, Table, Title, Flex } from '@mantine/core';
...
export default function Developer() {
                    ...
                    <Center>
                        <Card my='xl' shadow='sm' p='md' pt={0} radius='md' style={{width: '100%', maxWidth: '600px'}}>
                            ...
                            <Flex align='end' mb={4}>
                                ...
                                <Title color='dimmed' ml={4} order={6}>(Optional if using cookie)</Title>
                            </Flex>
                            <Table mb='lg' highlightOnHover withBorder withColumnBorders>
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td>Authorization</td>
                                        <td>Bearer YOUR-JWT-HERE</td>
                                        <td>If not using cookies</td>
                                    </tr>
                                </tbody>
                            </Table>
    ...
    "content": "Hello there!"
                            ...
                            <Text mt='lg' mb='xs'>And an example request payload with multiple messages will look like:</Text>
                            <Code block>
                                {`{
  "messages": [
    {
  ...
  "messages": []
                            ...
                            <Text mt='xl' mb='xs'>The response will contain the chat bot's response to the messages sent in the request:</Text>
                            <Title order={5} mt='md' mb={4} ml={4}>Response</Title>
                            <Table mb='lg' highlightOnHover withBorder withColumnBorders>
                                <thead>
                                    <tr>
